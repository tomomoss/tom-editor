...
現在、バージョン2.2.1です。以下より動作確認ができます。

[TOM Editor 2.2.1 動作確認ページ](https://tomomoss.github.io/tom-editor/trial)

## 更新履歴

### 2021/08/14: v2.2.1

エディターの実装対象となるHTML要素のスタイルによっては、エディターの寸法が実装対象の寸法と一致しなくなるバグを修正しました。
